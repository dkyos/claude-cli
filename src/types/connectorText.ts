...
const _err = (..._a: unknown[]): never => {
  throw new Error('stubbed module ../../types/connectorText.js reached at runtime')
}
...
export const ConnectorTextBlock: any = _proxy
export const ConnectorTextDelta: any = _proxy
export const isConnectorTextBlock: any = _proxy
